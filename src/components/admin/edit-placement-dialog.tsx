...
export default function EditPlacementDialog({
  placement,
  onUpdatePlacement,
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (
      Object.values(updatedPlacement).every(
        (field) =>
          field !== null &&
          field !== '' &&
          !isNaN(updatedPlacement.vacancies) &&
          !isNaN(updatedPlacement.requiredCgpa)
      )
    ) {
            ...
            <div className="grid grid-cols-1 gap-4 py-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  id="companyName"
                  name="companyName"
                  defaultValue={placement.companyName}
                  required
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="jobDescription"
                  name="jobDescription"
                  defaultValue={placement.jobDescription}
                  required
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="recruitingBranches"
                  name="recruitingBranches"
                  defaultValue={placement.recruitingBranches}
                  required
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  name="vacancies"
                  type="number"
                  defaultValue={placement.vacancies}
                  required
                />
              </div>
              <div className="space-y-2 sm:col-span-2">
                ...
                <Input
                  id="requiredSkills"
                  name="requiredSkills"
                  defaultValue={placement.requiredSkills.join(', ')}
                  required
                />
              </div>
              <div className="space-y-2 sm:col-span-2">
                ...
                <Input
                  ...
                  defaultValue={placement.recruitmentProcess}
                  required
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="number"
                  step="0.1"
                  defaultValue={placement.requiredCgpa}
                  required
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  name="driveDate"
                  type="date"
                  defaultValue={placement.driveDate}
                  required
                />
              </div>
              <div className="col-span-2 flex items-center space-x-2 pt-4">
                <Checkbox
                  ...
                  defaultChecked={placement.backlogsAllowed}
                />
