...
export default function AddFacultyDialog({ onAddFaculty }: AddFacultyDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (
      !newFacultyData.name ||
      !newFacultyData.email ||
      !newFacultyData.department ||
      !newFacultyData.designation ||
      !newFacultyData.contact.phone ||
      !newFacultyData.contact.office
    ) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the details for the new faculty member. All fields marked with * are required. For
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                name="password"
                type="password"
                placeholder="Leave blank for default (faculty123)"
                className="col-span-3"
              />
            </div>
