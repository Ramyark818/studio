...
export default function EditFacultyDialog({ faculty, onUpdateFaculty }: EditFacultyDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!updatedData.name || !updatedData.email || !updatedData.department || 
        !updatedData.designation || !updatedData.contact.phone || !updatedData.contact.office) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Make changes to the faculty member's details. All fields marked with * are required.
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="email" name="email" type="email" defaultValue={faculty.email} className="col-span-3" required />
            </div>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input 
                ...
                name="joiningDate" 
                type="date" 
                defaultValue={faculty.joiningDate ? new Date(faculty.joiningDate).toISOString().split('T')[0] : ''} 
                className="col-span-3" 
              />
            </div>
          </div>
